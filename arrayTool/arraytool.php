...
function arrayToXml($arr, $level = 1) {
    ...
    foreach ($arr as $tagname => $value) {
        ...
        if (!is_array($value)) {
            ...
            $s .= "<{$tagname}>" . arrayToXml($value, $level + 1) . "</{$tagname}>";
        }
    }
    //过滤不合法的字符串
...
//$arr=array("book"=>array("bookName"=>"a","bookPrice"=>"b"));
$arr=array("book"=>array("bookName"=>"a","bookPrice"=>"b"),"book2"=>array("bookName"=>"a","bookPrice"=>"c"),"book3"=>array("bookName"=>"a","bookPrice"=>"b"));
$abb=arrayToXml($arr);
print_r($abb);